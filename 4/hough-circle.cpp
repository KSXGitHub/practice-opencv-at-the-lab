...
const auto canny_threshold_initial_value = 200;
const auto accumulator_threshold_initial_value = 50;
const auto max_accumulator_threshold = 200;
const auto max_canny_threshold = 255;
...
int main () {
  ...
  auto canny_threshold = canny_threshold_initial_value;
  auto accumulator_threshold = accumulator_threshold_initial_value;
